...
class DatatransferTransfer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 on_create_activate_mode: Optional[pulumi.Input[str]] = None,
                 runtime: Optional[pulumi.Input[pulumi.InputType['DatatransferTransferRuntimeArgs']]] = None,
                 source_id: Optional[pulumi.Input[str]] = None,
                 target_id: Optional[pulumi.Input[str]] = None,
                 transformation: Optional[pulumi.Input[pulumi.InputType['DatatransferTransferTransformationArgs']]] = None,
                 type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] on_create_activate_mode: Activation action on create a new incremental transfer.
               ...
               For the documentation of the runtime and transformation see below.
        :param pulumi.Input[pulumi.InputType['DatatransferTransferRuntimeArgs']] runtime: Runtime parameters for the transfer.
        :param pulumi.Input[str] source_id: ID of the source endpoint for the transfer.
        :param pulumi.Input[str] target_id: ID of the target endpoint for the transfer.
        :param pulumi.Input[pulumi.InputType['DatatransferTransferTransformationArgs']] transformation: Transformation for the transfer.
        :param pulumi.Input[str] type: Type of the transfer. One of "SNAPSHOT_ONLY", "INCREMENT_ONLY", "SNAPSHOT_AND_INCREMENT".
        """
        ...
    @overload
