...
class GetCdnResourceResult:
    ...
    """
    def __init__(__self__, active=None, cname=None, created_at=None, folder_id=None, id=None, options=None, origin_group_id=None, origin_group_name=None, origin_protocol=None, provider_cname=None, resource_id=None, secondary_hostnames=None, ssl_certificate=None, updated_at=None):
