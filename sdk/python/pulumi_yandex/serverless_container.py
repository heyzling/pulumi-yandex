...
class ServerlessContainerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ServerlessContainerStorageMountArgs']]] storage_mounts: Storage mounts for Yandex Cloud Serverless Container
        """
...
class ServerlessContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 log_options: Optional[pulumi.Input[pulumi.InputType['ServerlessContainerLogOptionsArgs']]] = None,
                 memory: Optional[pulumi.Input[int]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 provision_policy: Optional[pulumi.Input[pulumi.InputType['ServerlessContainerProvisionPolicyArgs']]] = None,
                 secrets: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ServerlessContainerSecretArgs']]]]] = None,
                 service_account_id: Optional[pulumi.Input[str]] = None,
                 storage_mounts: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ServerlessContainerStorageMountArgs']]]]] = None,
                 __props__=None):
        """
        ...
        test_container = yandex.ServerlessContainer("test-container",
            ...
            log_options=yandex.ServerlessContainerLogOptionsArgs(
                log_group_id="e2392vo6d1bne2aeq9fr",
                min_level="ERROR",
            ),
            memory=256,
            provision_policy=yandex.ServerlessContainerProvisionPolicyArgs(
                min_instances=1,
            ),
        ...
        :param pulumi.Input[pulumi.InputType['ServerlessContainerImageArgs']] image: Revision deployment image for Yandex Cloud Serverless Container
               ...
               * `image.0.environment` -  A set of key/value environment variable pairs for Yandex Cloud Serverless Container
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: A set of key/value label pairs to assign to the Yandex Cloud Serverless Container
        :param pulumi.Input[pulumi.InputType['ServerlessContainerLogOptionsArgs']] log_options: Options for logging from Yandex Cloud Serverless Container
        :param pulumi.Input[int] memory: Memory in megabytes (**aligned to 128MB**) for Yandex Cloud Serverless Container
        :param pulumi.Input[str] name: Yandex Cloud Serverless Container name
        :param pulumi.Input[pulumi.InputType['ServerlessContainerProvisionPolicyArgs']] provision_policy: Provision policy. If specified the revision will have prepared instances 
               * `provision_policy.0.min_instances` - Minimum number of prepared instances that are always ready to serve requests
        ...
        :param pulumi.Input[str] service_account_id: Service account ID for Yandex Cloud Serverless Container
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ServerlessContainerStorageMountArgs']]]] storage_mounts: Storage mounts for Yandex Cloud Serverless Container
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @property
    @pulumi.getter(name="logOptions")
    def log_options(self) -> pulumi.Output['outputs.ServerlessContainerLogOptions']:
        """
        Options for logging from Yandex Cloud Serverless Container
        """
        return pulumi.get(self, "log_options")
