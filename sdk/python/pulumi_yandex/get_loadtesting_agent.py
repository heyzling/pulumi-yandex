...
class GetLoadtestingAgentResult:
    ...
    """
    def __init__(__self__, agent_id=None, compute_instance_id=None, compute_instances=None, description=None, folder_id=None, id=None, labels=None, name=None):
...
@_utilities.lift_output_func(get_loadtesting_agent)
def get_loadtesting_agent_output(agent_id: Optional[pulumi.Input[str]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetLoadtestingAgentResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
