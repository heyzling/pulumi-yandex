...
class IotCoreRegistry(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 folder_id: Optional[pulumi.Input[str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 log_options: Optional[pulumi.Input[pulumi.InputType['IotCoreRegistryLogOptionsArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 passwords: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        """
        ...
        my_registry = yandex.IotCoreRegistry("myRegistry",
            ...
            log_options=yandex.IotCoreRegistryLogOptionsArgs(
        ...
        :param pulumi.Input[str] folder_id: Log entries are written to default log group for specified folder
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: A set of key/value label pairs to assign to the IoT Core Registry.
        :param pulumi.Input[pulumi.InputType['IotCoreRegistryLogOptionsArgs']] log_options: Options for logging for IoT Core Registry
        :param pulumi.Input[str] name: IoT Core Device name used to define registry
        :param pulumi.Input[Sequence[pulumi.Input[str]]] passwords: A set of passwords's id for the IoT Core Registry
        """
        ...
