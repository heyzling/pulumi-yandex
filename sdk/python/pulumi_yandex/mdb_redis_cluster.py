...
class MdbRedisClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] sharded: Redis Cluster mode enabled/disabled. Enables sharding when cluster non-sharded.
...
class MdbRedisCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 deletion_protection: Optional[pulumi.Input[bool]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 disk_size_autoscaling: Optional[pulumi.Input[pulumi.InputType['MdbRedisClusterDiskSizeAutoscalingArgs']]] = None,
                 environment: Optional[pulumi.Input[str]] = None,
                 folder_id: Optional[pulumi.Input[str]] = None,
