...
class GetComputePlacementGroupResult:
    ...
    def placement_strategy(self) -> Optional[Mapping[str, Any]]:
...
def get_compute_placement_group(description: Optional[str] = None,
                                ...
                                placement_strategy: Optional[Mapping[str, Any]] = None,
...
def get_compute_placement_group_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                       ...
                                       placement_strategy: Optional[pulumi.Input[Optional[Mapping[str, Any]]]] = None,
