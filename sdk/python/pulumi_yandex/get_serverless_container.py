...
class GetServerlessContainerResult:
    ...
    """
    def __init__(__self__, concurrency=None, connectivity=None, container_id=None, core_fraction=None, cores=None, created_at=None, description=None, execution_timeout=None, folder_id=None, id=None, images=None, labels=None, log_options=None, memory=None, name=None, revision_id=None, secrets=None, service_account_id=None, storage_mounts=None, url=None):
...
def get_serverless_container(connectivity: Optional[pulumi.InputType['GetServerlessContainerConnectivityArgs']] = None,
                             ...
                             storage_mounts: Optional[Sequence[pulumi.InputType['GetServerlessContainerStorageMountArgs']]] = None,
...
def get_serverless_container_output(connectivity: Optional[pulumi.Input[Optional[pulumi.InputType['GetServerlessContainerConnectivityArgs']]]] = None,
                                    ...
                                    storage_mounts: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetServerlessContainerStorageMountArgs']]]]] = None,
