...
class Function(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 async_invocation: Optional[pulumi.Input[pulumi.InputType['FunctionAsyncInvocationArgs']]] = None,
                 concurrency: Optional[pulumi.Input[int]] = None,
                 ...
                 folder_id: Optional[pulumi.Input[str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 log_options: Optional[pulumi.Input[pulumi.InputType['FunctionLogOptionsArgs']]] = None,
                 memory: Optional[pulumi.Input[int]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 ...
                 service_account_id: Optional[pulumi.Input[str]] = None,
                 storage_mounts: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FunctionStorageMountArgs']]]]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 tmpfs_size: Optional[pulumi.Input[int]] = None,
                 user_hash: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[pulumi.InputType['FunctionAsyncInvocationArgs']] async_invocation: Config for asynchronous invocations of Yandex Cloud Function.
        :param pulumi.Input[int] concurrency: The maximum number of requests processed by a function instance at the same time.
        ...
        :param pulumi.Input[str] folder_id: Folder ID for the Yandex Cloud Function
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: A set of key/value label pairs to assign to the Yandex Cloud Function
        :param pulumi.Input[pulumi.InputType['FunctionLogOptionsArgs']] log_options: Options for logging from Yandex Cloud Function.
        :param pulumi.Input[int] memory: Memory in megabytes (**aligned to 128MB**) for Yandex Cloud Function
        :param pulumi.Input[str] name: Yandex Cloud Function name used to define trigger
        ...
        :param pulumi.Input[str] service_account_id: Service account ID for Yandex Cloud Function
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FunctionStorageMountArgs']]]] storage_mounts: Storage mounts for Yandex Cloud Function.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tags: Tags for Yandex Cloud Function. Tag "$latest" isn't returned.
        :param pulumi.Input[int] tmpfs_size: Tmpfs size for Yandex Cloud Function.
        :param pulumi.Input[str] user_hash: User-defined string for current function version. User must change this string any times when function changed. Function will be updated when hash is changed.
        """
    ...
    @property
    @pulumi.getter(name="logOptions")
    def log_options(self) -> pulumi.Output['outputs.FunctionLogOptions']:
        """
        Options for logging from Yandex Cloud Function.
        """
        return pulumi.get(self, "log_options")
