...
type VpcSecurityGroupRule struct {
	...
	//
	// > **NOTE:** Either one `port` argument or both `fromPort` and `toPort` arguments can be specified.
	//
	// > **NOTE:** If `port` or `fromPort`/`toPort` aren't specified or set by -1, ANY port will be sent.
	//
	// > **NOTE:** Can't use specified port if protocol is one of `ICMP` or `IPV6_ICMP`.
	//
	// > **NOTE:** One of arguments `v4CidrBlocks`/`v6CidrBlocks` or `predefinedTarget` or `securityGroupId` must be specified.
