...
type ApiGateway struct {
	...
	LogOptions ApiGatewayLogOptionsOutput `pulumi:"logOptions"`
...
// Options for logging from Yandex Cloud API Gateway.
func (o ApiGatewayOutput) LogOptions() ApiGatewayLogOptionsOutput {
	return o.ApplyT(func(v *ApiGateway) ApiGatewayLogOptionsOutput { return v.LogOptions }).(ApiGatewayLogOptionsOutput)
}
