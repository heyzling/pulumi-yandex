...
type LookupComputePlacementGroupArgs struct {
	...
	PlacementStrategy map[string]interface{} `pulumi:"placementStrategy"`
}
...
type LookupComputePlacementGroupOutputArgs struct {
	...
	PlacementStrategy pulumi.MapInput       `pulumi:"placementStrategy"`
}
...
func (o LookupComputePlacementGroupResultOutput) PlacementStrategy() pulumi.MapOutput {
	return o.ApplyT(func(v LookupComputePlacementGroupResult) map[string]interface{} { return v.PlacementStrategy }).(pulumi.MapOutput)
}
