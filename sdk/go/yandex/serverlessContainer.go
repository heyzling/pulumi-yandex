...
type ServerlessContainer struct {
	...
	LogOptions ServerlessContainerLogOptionsOutput `pulumi:"logOptions"`
...
// Options for logging from Yandex Cloud Serverless Container
func (o ServerlessContainerOutput) LogOptions() ServerlessContainerLogOptionsOutput {
	return o.ApplyT(func(v *ServerlessContainer) ServerlessContainerLogOptionsOutput { return v.LogOptions }).(ServerlessContainerLogOptionsOutput)
}
