...
import (
	...
	"github.com/heyzling/pulumi-yandex/provider/pkg/version"
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Keywords:   []string{"yandex", "yandex", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/heyzling/pulumi-yandex",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/heyzling/pulumi-yandex/sdk/",
